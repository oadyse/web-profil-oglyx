<div id="edit{{ $produk->id }}" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
    aria-labelledby="createTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                <h5 class="modal-title" id="createTitle">Edit Data Produk</h5>
            </div>
            <div class="modal-body" style="min-height:300px">
                <form method="POST" action="{{ route('edit', $produk->id) }}" class="needs-validation"
                    ...
                    <div class="form-row mb-3">
                        ...
                        <div class="col-9">
                            <small>
                                Gambar yang telah diupload: <b>{{ $produk->gambar }}</b>
                            </small><br>
                            <input class="mt-2" type="file" id="myFile" name="gambar">
                        </div>
                    </div>
                    <div class="form-row mb-3">
                        <div class="col-3 m-auto">
                        ...
                        <div class="col-9">
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="deskripsi" rows="3">{{ $produk->deskripsi }}</textarea>
                        </div>
                    </div>
                    <div class="form-row mb-3">
                        <div class="col-3 m-auto">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="validationTooltip05" name="harga"
